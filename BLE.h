...
#define CYBLE_ADV_PKT_INDEX_APPEARANCE   (0x16u)

#define CYBLE_SCN_PKT_INDEX_LOCAL_NAME   (0x00u)



/* Allign buffer size value to 4 */
#define CYBLE_ALIGN_TO_4(x)                         ((((x) & 3u) == 0u) ? (x) : (((x) - ((x) & 3u)) + 4u))

#define CYBLE_L2CAP_HEADER_SIZE                     (4u)

/* GATT MTU Size */
#define CYBLE_GATT_MTU                              (0x0017u)
#define CYBLE_GATT_MTU_PLUS_L2CAP_HEADER            (CYBLE_GATT_MTU + CYBLE_L2CAP_HEADER_SIZE)

/* Stack buffers count */
#define CYBLE_GATT_MTU_BUF_COUNT                    (2u)
#define CYBLE_STACK_BUF_COUNT                       (6u)

/* GATT Maximum attribute length */
#define CYBLE_GATT_MAX_ATTR_LEN                     (0x0012u)

/* L2CAP MTU Size */
#define CYBLE_L2CAP_MTU                             (23u)
#define CYBLE_L2CAP_MTU_PLUS_L2CAP_HEADER           (CYBLE_L2CAP_MTU + CYBLE_L2CAP_HEADER_SIZE)

/* L2CAP PMS Size */
#define CYBLE_L2CAP_MPS                             (23u)
#define CYBLE_L2CAP_MPS_PLUS_L2CAP_HEADER           (CYBLE_L2CAP_MPS + CYBLE_L2CAP_HEADER_SIZE)
...
/* RAM memory size required for stack */
    ...
    #define CYBLE_STACK_RAM_SIZE   CYBLE_ALIGN_TO_4(CYBLE_DEFAULT_RAM_SIZE_SOC + \
        ...
        CYBLE_GATT_MAX_ATTR_LEN + \
        (CYBLE_L2CAP_PSM_SIZE * CYBLE_L2CAP_PSM_COUNT) + \
        (CYBLE_L2CAP_CBFC_CHANNEL_SIZE * CYBLE_L2CAP_LOGICAL_CHANNEL_COUNT) + \
        (CYBLE_L2CAP_MTU_PLUS_L2CAP_HEADER * CYBLE_L2CAP_LOGICAL_CHANNEL_COUNT) + \
        (CYBLE_L2CAP_MPS_PLUS_L2CAP_HEADER * CYBLE_L2CAP_LOGICAL_CHANNEL_COUNT * (CYBLE_L2CAP_MTU / CYBLE_L2CAP_MPS)) + \
