...
const CYBLE_DISS_T cyBle_diss =
{
    0x0014u,    /* Handle of the DIS service */
    {
        ...
        0x001Au, /* Handle of the Serial Number String characteristic */ 
        0x001Cu, /* Handle of the Hardware Revision String characteristic */ 
        0x001Eu, /* Handle of the Firmware Revision String characteristic */ 
        0x0020u, /* Handle of the Software Revision String characteristic */ 
        0x0022u, /* Handle of the System ID characteristic */ 
        0x0024u, /* Handle of the IEEE 11073-20601 Regulatory Certification Data List characteristic */ 
        0x0026u, /* Handle of the PnP ID characteristic */ 
    },
};
